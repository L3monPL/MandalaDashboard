...
export class ServicesSectionComponent {
  services: Service[] = [
    {
      num: '01',
      image: 'assets/image-service/planowanie-min.png',
    ...
    {
      num: '02',
      image: 'assets/image-service/develop-min.png',
    ...
    {
      num: '03',
      image: 'assets/image-service/osiedla-min.png',
    ...
    {
      num: '04',
      image: 'assets/image-service/serwis-konserwatorski-min.png',
